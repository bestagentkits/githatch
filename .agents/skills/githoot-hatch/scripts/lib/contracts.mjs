...
export const EMOTION_POSE_SET = Object.freeze([
  { id: 'portrait', label: 'Portrait / Chan dung', icon: '👤', col: 0, row: 0 },
  ...
  { id: 'proud', label: 'Proud / Kieu hanh', icon: '👑', col: 0, row: 1 },
  { id: 'combat', label: 'Combat / Chien dau', icon: '⚔️', col: 1, row: 1 },
