...
import type { Env, GitHubUserRaw } from '../../types';
...
export async function generateSignedState(claimUsername: string, secret: string): Promise<string> {
  const payload: OAuthStatePayload = {
    claim_username: claimUsername.toLowerCase(),
    timestamp: Date.now(),
