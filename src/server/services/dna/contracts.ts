// ============================================================================
// GitHoot Deterministic DNA & Hatch Contracts (src/server/services/dna/contracts.ts)
// ============================================================================

import type { RarityTier } from '../../types';
import ALLOWLIST_DATA from './model-allowlist.json';
...
export const MODEL_ALLOWLIST: readonly string[] = Object.freeze(ALLOWLIST_DATA);
...
export const GATES = Object.freeze({
  maxLargeComponents: 4,
  dominanceRatio: 0.30,
  minBboxFill: 0.06,
  maxBboxAspect: 3.2,
  componentMinAreaRatio: 0.003,
  alphaThreshold: 24,
...
export interface PoseDefinition {
  id: string;
  label: string;
  beat: 'airborne' | 'impact' | 'recover' | 'finish';
}

export const POSE_SET: readonly PoseDefinition[] = Object.freeze([
...
export const POSE_PROMPT: Readonly<Record<string, string>> = Object.freeze({
...
export const SPECIES: readonly SpeciesEntry[] = Object.freeze([
...
export const SPECIES_PHENOTYPE: Readonly<Record<string, { silhouettes: string[]; crests: string[] }>> = Object.freeze({
...
export const SPECIES_BUILDS: Readonly<Record<string, string[]>> = Object.freeze({
...
export const BUILD_PROMPT: Readonly<Record<string, string>> = Object.freeze({
...
export const RARITIES: readonly RarityTier[] = Object.freeze(['Common', 'Rare', 'Epic', 'Legendary', 'Mythic']);

export const RARITY_CUTS = Object.freeze([
  { tier: 'Common' as RarityTier, max: 0.45 },
  { tier: 'Rare' as RarityTier, max: 0.68 },
  { tier: 'Epic' as RarityTier, max: 0.84 },
  { tier: 'Legendary' as RarityTier, max: 0.94 },
  { tier: 'Mythic' as RarityTier, max: 1.01 }
]);
