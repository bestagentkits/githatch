...
|---|---|---|---|---|
| **API** | Healthcheck Endpoint GET /health | ✅ PASS | 15ms | Status: ok, Domain: githoot.com |
...
| **API** | Dynamic OpenGraph Card GET /og/octocat | ✅ PASS | 151ms | OG Image Size: 1200x630, Bytes: 3338 |
