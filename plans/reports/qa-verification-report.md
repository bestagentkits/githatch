...
|---|---|---|---|---|
| **API** | Healthcheck Endpoint GET /health | ✅ PASS | 24ms | Status: ok, Domain: githoot.com |
| **API** | Early Access Status GET /api/early-access/status | ✅ PASS | 1ms | Total Slots: 100, Free Available: true |
| **API** | Dynamic SVG README Badge GET /badge/octocat.svg | ✅ PASS | 1228ms | SVG Length: 1010 bytes, Cache-Control: public, max-age=43200, s-maxage=43200 |
| **API** | Dynamic OpenGraph PNG Card GET /og/octocat.png (with mixed Accept header) | ✅ PASS | 547ms | Format: PNG, Bytes: 185584, Content-Type: image/png |
| **API** | Dynamic OpenGraph SVG Card GET /og/octocat.svg | ✅ PASS | 232ms | Format: SVG, Bytes: 7226, Content-Type: image/svg+xml; charset=utf-8 |
...
| **Resolver** | GitHub Profile Resolution GET /api/profile/octocat | ✅ PASS | 227ms | Source: github_live, Egg: solar-flare, Login: @octocat |
| **Resolver** | 404 User Not Found Propagation for Non-existent User | ✅ PASS | 323ms | HTTP 404 correctly returned for non-existent user |
