...
|---|---|---|---|---|
| **API** | Healthcheck Endpoint GET /health | ✅ PASS | 68ms | Status: ok, Domain: githoot.com |
| **API** | Early Access Status GET /api/early-access/status | ✅ PASS | 1ms | Total Slots: 100, Free Available: true |
| **API** | Dynamic SVG README Badge GET /badge/octocat.svg | ✅ PASS | 952ms | SVG Length: 1010 bytes, Cache-Control: public, max-age=43200, s-maxage=43200 |
| **API** | Dynamic OpenGraph PNG Card GET /og/octocat.png (with mixed Accept header) | ✅ PASS | 954ms | Format: PNG, Bytes: 183615, Content-Type: image/png |
| **API** | Dynamic OpenGraph SVG Card GET /og/octocat.svg | ✅ PASS | 152ms | Format: SVG, Bytes: 7090, Content-Type: image/svg+xml; charset=utf-8 |
| **API** | Crawler HTML Dynamic OpenGraph Tags GET /octocat | ✅ PASS | 1ms | Injected: og:image=/og/octocat.png?v=2, og:title=@octocat · GitHoot Realm Guardian |
| **DNA** | Deterministic DNA Hash Consistency | ✅ PASS | 0ms | Species: Aether Neon Byte, Element: Cyber, Rarity: Common |
| **Resolver** | GitHub Profile Resolution GET /api/profile/octocat | ✅ PASS | 117ms | Source: github_live, Egg: solar-flare, Login: @octocat |
| **Resolver** | 404 User Not Found Propagation for Non-existent User | ✅ PASS | 517ms | HTTP 404 correctly returned for non-existent user |
