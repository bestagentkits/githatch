...
| **API** | Dynamic SVG README Badge GET /badge/octocat.svg | ✅ PASS | 889ms | SVG Length: 1010 bytes, Cache-Control: public, max-age=43200, s-maxage=43200 |
| **API** | Dynamic OpenGraph PNG Card GET /og/octocat.png (with mixed Accept header) | ✅ PASS | 439ms | Format: PNG, Bytes: 183615, Content-Type: image/png |
| **API** | Dynamic OpenGraph SVG Card GET /og/octocat.svg | ✅ PASS | 138ms | Format: SVG, Bytes: 7090, Content-Type: image/svg+xml; charset=utf-8 |
...
| **Resolver** | GitHub Profile Resolution GET /api/profile/octocat | ✅ PASS | 125ms | Source: github_live, Egg: solar-flare, Login: @octocat |
| **Resolver** | 404 User Not Found Propagation for Non-existent User | ✅ PASS | 443ms | HTTP 404 correctly returned for non-existent user |
